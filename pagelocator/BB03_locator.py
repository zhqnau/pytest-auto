...
level4menu = (By.XPATH, '//span[text()="单位复核管理（初审）"]')

iframe = (By.XPATH, '//*[@id="pane-mbs-emp-rew-01"]/div/iframe')
...
BIZ_TYPE = (By.XPATH, '//div[@class="ant-select-selection__placeholder"]')

BIZ_TYPE_LIST = (By.XPATH, '//li[text()="单位信息维护"]')
# bGYP = (By.XPATH, '//ul[contains(@class,"el-scrollbar__view el-select-dropdown__list")]/li/span')[11]
BIZ_TYPE_1 = (By.XPATH, '//div[@id="app"]/following-sibling::div[@class="el-select-dropdown el-popper"]'
                           '//span[text()="办公用品"]')
...
close = (By.XPATH, '//div[@id="tab-mbs-emp-rew-01"]/span')
