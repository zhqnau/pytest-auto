...
level3menu = (By.XPATH, '//span[text()="内控检查时限设置"]')
iframe = (By.XPATH, '//*[@id="pane-ICSB04TIMELIMITSET11"]/div/iframe')
...
save_button = (By.XPATH, '//div[@aria-label="时限设置"]//button/span[contains(text(),"保存")]')
...
close = (By.XPATH, '//div[@id="tab-ICSB04TIMELIMITSET11"]/span')
