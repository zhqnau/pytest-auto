...
level3menu = (By.XPATH, '//span[text()="内控任务结果上报"]')
iframe = (By.XPATH, '//*[@id="pane-ICSB09TASKRESULT0009"]/div/iframe')
# ym = (By.XPATH, '//label[@for="susptCrteTime"]/..//input')
# query_button = (By.XPATH, '//div[@class="hsa-row el-row"]//button/span[contains(text(),"查询")]')
# increase = (By.XPATH, '//div[@role="tab"]//button/span[contains(text(),"生成")]')
...
# ascertain = (By.XPATH, '//div[@class="el-message-box__wrapper"]//button/span[contains(text(),"是")]')
# undo = (By.XPATH, '//div[@role="tab"]//button/span[contains(text(),"撤销")]')
#
# ascertain = (By.XPATH, '//div[@class="el-message-box__wrapper"]//button/span[contains(text(),"是")]')
# txt1 = (By.XPATH, '//div[@id="app"]/following-sibling::div[@role="alert"]/p')
close = (By.XPATH, '//div[@id="tab-ICSB09TASKRESULT0009"]/span')

generate = (By.XPATH, '//div[@role="tab"]//button/span[contains(text(),"生成")]')
timeListks = (By.XPATH, '//div[@aria-label="内控任务结果概述"]//label[@for="timeList"]/..//input[@placeholder="开始月份"]')
timeListjs = (By.XPATH, '//div[@aria-label="内控任务结果概述"]//label[@for="timeList"]/..//input[@placeholder="结束月份"]')
taskRsltRpupTtl = (By.XPATH, '//div[@aria-label="内控任务结果概述"]//label[@for="taskRsltRpupTtl"]/..//input')
taskRsltRpupCont = (By.XPATH, '//div[@aria-label="内控任务结果概述"]//label[@for="taskRsltRpupCont"]/..//textarea')
save_button = (By.XPATH, '//div[@aria-label="内控任务结果概述"]//button/span[contains(text(),"保存")]')
